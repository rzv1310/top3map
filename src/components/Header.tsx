      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-background hover:bg-background/80 text-foreground font-bold text-sm uppercase tracking-wider px-5 py-2.5 transition-colors border border-border"
          >
        ...
        <div className="md:hidden bg-background/95 backdrop-blur-md border-b border-border overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
          <nav className="flex flex-col px-4 py-6 gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-background hover:bg-background/80 text-foreground font-bold text-base uppercase tracking-wider px-5 py-3 transition-colors mt-2 border border-border"
            >
