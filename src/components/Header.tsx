      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="flex items-center gap-3 md:gap-8">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 bg-background hover:bg-background/80 text-foreground font-bold text-sm uppercase tracking-wider px-5 py-2.5 transition-colors border border-border"
          >
